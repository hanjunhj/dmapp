...
import com.baidu.location.demo.vo.OccurrenceScope;
...
public class MapActivity extends AppCompatActivity implements BaiduMap.OnMapClickListener{
    ...
    private EditText datetime_occ;
    private Spinner event_type;
    private Spinner occurrence_area;
    private Spinner occurrence_scope;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.datetime_occ = findViewById(R.id.datetime_occ);
        ...
        this.occurrence_scope = findViewById(R.id.occurrence_scope);
        ...
        HttpResponse<OccurrenceScope[]> httpResponse3 = Http.Request2("occurrencescope", null, OccurrenceScope[].class);
        ArrayList<KeyValuePair> arrayList3 = new ArrayList<>();
        //arrayList3.add(new KeyValuePair("", "No limit"));
        if (httpResponse3 != null) {
            for (OccurrenceScope item : httpResponse3.Data) {
                arrayList3.add(new KeyValuePair(item.code, item.scope));
            }
            occurrence_scope.setAdapter(new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, arrayList3));
        }
        ...
        this.datetime_occ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                new TimePickerDialog(MapActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        datetime_occ.setText(hourOfDay+":"+minute+":00");
                    }
                ...
                if(isDateStringValid(time_occ.getText().toString().trim())){
                    if(time_occ.getText().length()==10){
                        ...
                        )
                        {
                            ...
                            eventInfo.dateTimeOcc = String.valueOf(datetime_occ.getText());
                            ...
                            eventInfo.location = String.valueOf(location.getText());
                            ...
                            eventInfo.occurrenceScope = String.valueOf(((KeyValuePair) occurrence_scope.getSelectedItem()).Key);
    ...
    private void loadData() {
        ...
        if (httpResponse != null) {
            ...
            for (EventInfo item : httpResponse.Data) {
                int radius = Integer.parseInt(item.occurrenceScopeValue.replaceAll("[a-zA-Z]", ""));
